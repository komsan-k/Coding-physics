...
This document explains how to convert a Roll--Pitch--Yaw (RPY)
orientation system into a 2 Degrees of Freedom (DOF) Pan--Tilt
system suitable for servo-based platforms such as camera mounts,
antenna pointing systems, or CPS robotics labs.
---
1. Original Orientation System (RPY)
Smartphones typically output orientation in:
...
A pan‑tilt mechanism only has two rotational axes.
DOF    Motion              Axis
---
...
The reduced orientation becomes:
DOF = 2
q = [pan, tilt]
Where
pan = θp  
...
---
Summary
The RPY orientation model from smartphone sensors can be simplified
to a 2‑DOF Pan‑Tilt model by selecting:
Pan = Yaw  
Tilt = Pitch
This simplification allows efficient implementation using two servo
motors, making it ideal for robotics, IoT, and CPS educational
platforms.
